...
const file = path.resolve(__dirname, "fixtures/todo-edge.ts");
const cfg = {
  ...
  todoComment: true, consoleCall: false, smallSwitch: false, emptyCatch: false,
  emptyCatchIgnoreCommented: false, anyType: false, paramCount: false, functionLength: false,
  nestingDepth: false, mergeConflict: false, unusedFile: false, consoleMethods: ["log"],
};
